...
export const HomeBackground = () => {
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      ...
      {/* Form Chart - Top Left */}
      <div className="absolute top-20 left-8 opacity-[0.08] transform -rotate-6">
      ...
      <div className="absolute top-32 right-12 opacity-[0.06] transform rotate-3">
      ...
      {actions.map((action, i) => (
        <div
          key={i}
          className="absolute opacity-[0.05] transform"
          style={{
            top: `${20 + (i * 7) % 60}%`,
      ...
      <div className="absolute bottom-32 left-6 opacity-[0.06] transform rotate-2">
      ...
      <div className="absolute bottom-20 right-8 opacity-[0.05] transform -rotate-3">
      ...
      {/* Floating R90 scores */}
      <div className="absolute top-1/2 left-1/4 opacity-[0.04] transform -translate-y-1/2">
        <span className="text-8xl font-bebas text-primary">1.74</span>
      </div>
      <div className="absolute top-1/3 right-1/4 opacity-[0.03] transform">
        <span className="text-6xl font-bebas text-foreground">R90</span>
      </div>

      {/* Additional scattered metrics */}
      <div className="absolute top-[60%] left-[15%] opacity-[0.04]">
      ...
      <div className="absolute top-[45%] right-[20%] opacity-[0.04]">
