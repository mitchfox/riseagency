  ...
  ({ className, marble, ...props }, ref) => (
    <div 
      ...
      className={cn(
        ...
        marble ? "bg-[url('/smudged-marble-header.png')] bg-cover bg-center bg-no-repeat border-b-2 border-[hsl(var(--accent))] p-3 min-h-[60px] flex items-center justify-start" : "p-6",
        className
      )} 
      {...props} 
    />
