    ...
    <>
      <div className="-space-y-1">
        ...
        {videoThumbnails.length > 0 && (
          <Card className="w-screen relative left-[50%] right-[50%] -ml-[50vw] -mr-[50vw] rounded-none border-x-0 border-t-[3px] border-t-[hsl(43,49%,61%)] border-b-[3px] border-b-[hsl(43,49%,61%)] z-25 !mt-0 !mb-[5px]">
