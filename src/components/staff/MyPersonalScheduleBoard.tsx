...
import { ChevronLeft, ChevronRight, Check, Plus, Trash2, ClipboardList } from "lucide-react";
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-[220px_1fr] gap-3">
        {/* My Tasks rail */}
        <div className="border rounded-md p-2 bg-muted/20 h-[520px] overflow-y-auto">
          ...
          <div className="space-y-1.5">
            {tasks.map((t) => (
              <div
                ...
                className="text-xs p-2 rounded border bg-card cursor-grab active:cursor-grabbing hover:border-primary/50"
          ...
          {weekDays.map((d, idx) => {
            ...
            return (
              <div
                ...
                className={`border rounded-md p-1.5 flex flex-col bg-card/50 ${isToday ? "border-primary/60" : ""}`}
              >
                ...
                <div className="flex-1 overflow-y-auto space-y-1">
                  {dayItems.map((it) => (
                    <div
                      ...
                      className={`group text-[11px] rounded border p-1.5 bg-background ${it.done_at ? "opacity-50 line-through" : ""}`}
                    >
                      <div className="flex items-start gap-1">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-[9px] text-muted-foreground">{it.start_time.slice(0,5)}–{it.end_time.slice(0,5)}</div>
                        </div>
      ...
      <div className="text-[11px] text-muted-foreground">
        Drag tasks from the rail onto any day. Double-click a day after typing in the quick-add box to drop it there. Drag an item between days to move it.
      </div>
    </div>
  );
};
