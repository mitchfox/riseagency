...
export default function ViewedVisitorsExpansion({ visits }: { visits: ProposalVisit[] }) {
  ...
  return (
    <div
      className="pointer-events-none grid grid-rows-[0fr] opacity-0 transition-all duration-300 ease-out group-hover/viewed:pointer-events-auto group-hover/viewed:grid-rows-[1fr] group-hover/viewed:opacity-100 group-focus-within/viewed:grid-rows-[1fr] group-focus-within/viewed:opacity-100"
    >
      <div className="overflow-hidden">
        <div className="mt-2 rounded-xl border border-[#cbb96b]/40 bg-background/95 backdrop-blur-sm shadow-lg shadow-black/40">
          <div className="flex items-center justify-between px-3 py-2 border-b border-border/60">
            ...
            <span className="text-[10px] text-muted-foreground">{sessions.length} visitor{sessions.length === 1 ? "" : "s"}</span>
          </div>
