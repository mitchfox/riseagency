      ...
      >
        ...
        <div className="relative w-32 h-40 flex-shrink-0 overflow-hidden">
          ...
          <div className="absolute top-3 right-3">
            <span className="text-5xl font-bold text-primary tracking-wider" style={{ fontFamily: "'Barlow Condensed', 'Bebas Neue', sans-serif" }}>
              {player.position}
            </span>
          </div>
        </div>
    ...
    >
      ...
      <div className="relative aspect-[3/4] overflow-hidden">
        ...
        <div className="absolute top-4 right-4">
          <span className="text-6xl font-bold text-primary tracking-wider" style={{ fontFamily: "'Barlow Condensed', 'Bebas Neue', sans-serif" }}>
            {player.position}
          </span>
        </div>
      </div>
