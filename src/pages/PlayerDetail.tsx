          ...
          <div className="mb-8">
            <div className="relative aspect-video bg-secondary/30 rounded-lg overflow-hidden border-4 md:border-[6px] border-[hsl(var(--gold))]">
              ...
              {dbHighlights.length > 0 && (
                <div className="absolute bottom-[53px] md:bottom-[69px] left-1/2 -translate-x-1/2 z-10 w-full px-2 pointer-events-none">
              ...
              {dbHighlights.length > 0 && (
                <div className="hidden lg:block absolute bottom-[53px] md:bottom-[69px] left-4 z-20 bg-[hsl(var(--gold))]/20 backdrop-blur-sm px-3 py-1.5 rounded-md border border-[hsl(var(--gold))]/40">
