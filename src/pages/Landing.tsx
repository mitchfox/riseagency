...
function LandingContent() {
  ...
  return <div className="bg-black flex flex-col items-center justify-end relative overflow-hidden cursor-none md:cursor-none" style={{
    ...
    maxHeight: '100dvh'
      ...
      {/* Hidden text revealed by X-ray - REALISE POTENTIAL - behind overlay at z-[1], moved up 25px */}
      <div className="absolute top-16 md:top-20 left-1/2 transform -translate-x-1/2 z-[1] pointer-events-none" style={{ marginTop: '-25px' }}>
      ...
      {/* Language Selector - centered on page, moved down 66px, right 1px */}
      <div className="absolute z-50" style={{
      top: 'calc(50% + 66px)',
      left: 'calc(50% + 1px)',
