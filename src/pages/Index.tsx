        ...
        <section className="pt-28 md:pt-32 pb-12 md:pb-20 px-4 bg-background relative overflow-hidden">
          ...
          <div className="container mx-auto max-w-7xl relative z-10">
            ...
            <div className="mt-12 md:mt-16">
              <div className="border border-border/50 bg-card/30 backdrop-blur-sm p-4 md:p-6">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
                  ...
                  >
                    <div className="space-y-2 md:space-y-3">
                      <h3 className="text-lg md:text-2xl font-bebas uppercase tracking-wider text-foreground group-hover:text-primary transition-colors">
                        Players
                      </h3>
                      <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">
                        Elite representation and development for professional footballers.
                      </p>
                  ...
                  >
                    <div className="space-y-2 md:space-y-3">
                      ...
                      <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">
                        Partner with us to discover and develop exceptional talent.
                      </p>
                      <span className="inline-flex items-center text-xs text-primary opacity-0 group-hover:opacity-100 transition-opacity">
                        Learn More →
                      </span>
                  ...
                  >
                    <div className="space-y-2 md:space-y-3">
                      ...
                      <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">
                        Join our global network and help identify rising stars.
                      </p>
                      <span className="inline-flex items-center text-xs text-primary opacity-0 group-hover:opacity-100 transition-opacity">
                        Join Network →
                      </span>
